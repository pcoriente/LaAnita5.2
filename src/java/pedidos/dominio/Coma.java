...
public class Coma {
    ...
    private float empaque;
    private String descripcion;
    private double mercanciasSinCargo;
    ...
    public double getMercanciasSinCargo() {
        return mercanciasSinCargo;
    }

    public void setMercanciasSinCargo(double mercanciasSinCargo) {
        this.mercanciasSinCargo = mercanciasSinCargo;
    }
